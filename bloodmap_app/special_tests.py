...
# ==== PATCH: auto keys + single-run guard (module-local, patch-only) ====
import re
try:
    import streamlit as st
except Exception:
...
# ---- Key builders (override, last definition wins) ----
...
# ---- Auto-key wrappers for common widgets ----
if st is not None:
...
# ---- Single-run render guard for special_tests_ui ----
try:
    ...
    # special_tests_ui not defined yet at import time; defer wrap via lazy hook
    pass
# ==== /PATCH ====
