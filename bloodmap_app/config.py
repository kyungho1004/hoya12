...
APP_TITLE = "🩸 피수치 가이드 / BloodMap v3.14+ (통합 패키지)"
PAGE_TITLE = "피수치 가이드 / BloodMap"
MADE_BY = "제작: Hoya/GPT  ·  자문: Hoya/GPT"
CAFE_LINK_MD = "[네이버 카페: 피수치 가이드 공식카페](https://cafe.naver.com/bloodmap)"
FOOTER_CAFE = "© 2025 BloodMap · 문의/피드백: 피수치 가이드 공식카페"
DISCLAIMER = "본 자료는 보호자의 이해를 돕기 위한 참고용 정보이며, 모든 의학적 판단은 주치의의 권한입니다."
...
FEVER_GUIDE = "38.0~38.5℃: 해열제 고려/경과 관찰 · 38.5℃ 이상: 병원 연락 · 39℃ 이상: 즉시 병원 방문"
