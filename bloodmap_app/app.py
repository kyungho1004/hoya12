...
# ---------- Tabs ----------
tab_labels = ["🏠 홈", "🧪 피수치 입력", "🧬 암 선택", "💊 항암제(진단 기반)", "👶 소아 증상", "🔬 특수검사", "📝 기록", "📄 보고서"]
t_home, t_labs, t_dx, t_chemo, t_peds, t_special, t_log, t_report = st.tabs(tab_labels)
...
with t_log:
    # ---------- 오른쪽: 기록/그래프/내보내기 ----------
        with tab_rec:
            ...
            tab_rec, tab_plot, tab_export = st.tabs(["📝 기록", "📈 그래프", "⬇️ 내보내기"])
