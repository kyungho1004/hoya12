...
DRUG_NAME_KR = {
    ...
    "MTX(유지)": "메토트렉세이트",
    "Hyper-CVAD": "하이퍼-CVAD",
    "CODOX-M/IVAC-R": "코독스-M/IVAC-R",
    "DA-EPOCH-R": "DA-EPOCH-R",
    "R-CHOP": "리툭시맙+사이클로포스파마이드+독소루비신+빈크리스틴+프레드니손",
    "Pola-R-CHP": "폴라투주맙 포함 R-CHP",
    "R-ICE": "이포스파마이드+카보플라틴+에토포시드+리툭시맙",
    "R-DHAP": "데사메타손+시타라빈+시스플라틴+리툭시맙",
    "R-GDP": "젬시타빈+덱사메타손+시스플라틴+리툭시맙",
    "R-GemOx": "젬시타빈+옥살리플라틴+리툭시맙",
    "ABVD": "독소루비신+블레오마이신+빈블라스틴+다카르바진",
    "BV-AVD": "브렌툭시맙+독소루비신+빈블라스틴+다카르바진",
    "CHOP/CHOEP": "CHOP/CHOEP",
    "SMILE": "스테로이드+메토트렉세이트+이포스파마이드+L-아스파라기나아제+에토포시드",
    ...
    "Zanubrutinib": "자누브루티닙",
    "Venetoclax(+Obinutuzumab)": "베네토클락스(+오비누투주맙)",
    "Rituximab/Obinutuzumab/Ofatumumab": "리툭시맙/오비누투주맙/오파투무맙",
    "Idelalisib/Duvelisib(제한적)": "이델랄리십/두벨리십",
    ...
    "Cisplatin+Paclitaxel+Bevacizumab": "시스플라틴+파클리탁셀+베바시주맙",
    "Cisplatin+RT(근치)": "시스플라틴+방사선",
    ...
    "NTRK(Larotrectinib/Entrectinib)": "라로트렉티닙/엔트렉티닙",
    ...
    "Selpercatinib/Pralsetinib(RET)": "셀퍼카티닙/프랄세티닙(RET)",
    "Vandetanib": "반데타닙",
    "Pola-BR": "폴라투주맙+벤다무스틴+리툭시맙",
    "Obinutuzumab+BR": "오비누투주맙+벤다무스틴+리툭시맙",
    "Lenalidomide+Rituximab": "레날리도마이드+리툭시맙",
    "BR": "벤다무스틴+리툭시맙",
    "R-CVP": "리툭시맙+사이클로포스파마이드+빈크리스틴+프레드니솔론",
    "ICE": "이포스파마이드+카보플라틴+에토포시드",
    "DHAP": "데사메타손+시타라빈+시스플라틴",
    "GDP": "젬시타빈+덱사메타손+시스플라틴",
    "GemOx": "젬시타빈+옥살리플라틴",
    "HiDAC": "고용량 사이타라빈(HiDAC)",
    "AZA+VEN": "아자시티딘+베네토클락스(AZA+VEN)",
    "Cytarabine(Ara-C, 고용량)": "사이타라빈(고용량)",
    "Cytarabine 포함": "사이타라빈 포함",
    "Aspa 기반": "L-아스파라기나아제 기반",
    "RT 병합": "방사선 병합",
    "Ifosfamide": "이포스파마이드",
    "Trabectedin": "트라벡테딘",
    "Eribulin": "에리불린",
    "Gemcitabine+Docetaxel": "젬시타빈+도세탁셀",
    "Ifosfamide+Etoposide": "이포스파마이드+에토포시드",
    "Paclitaxel": "파클리탁셀",
    "Docetaxel": "도세탁셀",
    "Ixazomib": "익사조밉",
    "Carfilzomib": "카필조밉",
    "Blinatumomab(CD19 BiTE)": "블리나투모맙(CD19 BiTE)",
    "Inotuzumab ozogamicin(CD22 ADC)": "이노투주맙 오조가마이신(CD22 ADC)",
    "Rituximab(CD20+, 일부 B-ALL)": "리툭시맙(CD20+, 일부 B-ALL)",
    "Nelarabine(T-ALL)": "넬라라빈(T-ALL)",
    "ATRA(베사노이드)": "ATRA(베사노이드)",
    "ATO": "산화비소(ATO)",
    "Luspatercept": "루스파테르셉트",
    "Ivosidenib/Enasidenib(IDH)": "이보시데닙/에나시데닙(IDH)",
    "ET(AI/Tamoxifen)+CDK4/6i": "내분비치료(아로마타아제/타목시펜)+CDK4/6 억제제",
    "Fulvestrant": "풀베스트란트",
    "Everolimus+Exemestane": "에베로리무스+엑세메스탄",
    "DCF": "독세탁셀+시스플라틴+5-FU",
    "PARP inhibitor(BRCA)": "PARP 억제제(BRCA)",
    "CVD(Cyclophosphamide+Vincristine+DTIC)": "사이클로포스파마이드+빈크리스틴+DTIC(CVD)",
    "VDC/IE": "빈크리스틴·독소루비신·사이클로포스파마이드 / 이포스파마이드·에토포시드",
    "VAC/IVA": "빈크리스틴·액티노마이신D·사이클로포스파마이드 / 이포스파마이드·빈크리스틴·액티노마이신D",
}


def korean_only_drug(name: str) -> str:
    """영문 약명을 한글만 보이도록 변환.
    우선순위: DRUG_NAME_KR 매핑 > 괄호 안 한글 추출 > 원문에 한글 있으면 그대로 > 원문(대비용).
    """
    try:
        raw = (name or "").strip()
    except Exception:
        return name
    # 매핑 우선
    kr = DRUG_NAME_KR.get(raw)
    if kr:
        return kr
    # 괄호 안 한글 추출
    m = re.search(r"\(([^)]*)\)", raw)
    if m and re.search(r"[가-힣]", m.group(1) or ""):
        return (m.group(1) or "").strip()
    # 원문 자체에 한글이 있으면 원문 유지
...
def with_korean_drug(name: str) -> str:
    try:
        ...
        return name
    kr = DRUG_NAME_KR.get(name.strip())
    if kr:
        return f"{name} ({kr})"
    return name
