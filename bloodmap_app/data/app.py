...
# 절대 임포트로 변경 (Streamlit Cloud 상대임포트 이슈 회피)
from bloodmap_app.utils import get_user_key, save_session, load_session
from bloodmap_app.drug_data import ANTINEOPLASTICS, ANTIBIOTICS, SARCOMA_DIAGNOSES

APP_TITLE = "🩸 피수치 가이드 / BloodMap — v3.14 (특수검사 정리·연구자 모드, abs import)"
