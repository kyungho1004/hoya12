# =====================================================================
# Phase 29 Stubbed Build Notice
# - 본 파일은 레거시 대블록을 "주석 스텁" 처리한 변형본입니다.
# - 레거시 렌더는 호출하지 않고, 모듈 라우터(features.app_router)에서만 렌더합니다.
# - 원본 app.py는 app_backup_before_stub.py로 백업되어 있습니다.
# =====================================================================
