# -*- coding: utf-8 -*-
"""
streamlit_app.py — BloodMap '전체 복원' 엔트리 (v3-restore)
- Streamlit Cloud 기본 엔트리 이름을 위한 복구본
- 기능은 app_restored.py와 동일(버튼 게이트/안전 폴백/외부저장/eGFR/식이가이드/보고서)
"""
...
# ---------------- Page meta & CSS ----------------
st.set_page_config(page_title="BloodMap — 전체 복원 패치(엔트리)", layout="wide")
st.title("BloodMap (복원 엔트리)")
